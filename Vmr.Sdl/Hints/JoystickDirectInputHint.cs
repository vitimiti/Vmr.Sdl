// -----------------------------------------------------------------------
// <copyright file="JoystickDirectInputHint.cs" company="Vmr.Sdl">
...
/// <summary>A variable controlling whether DirectInput should be used for controllers.</summary>
/// <remarks>You can set this hint through the environment variable "SDL_JOYSTICK_DIRECTINPUT" with the values "1" to enable or "0" to disable.</remarks>
public sealed class JoystickDirectInputHint : HintBase
{
    private const string Hint = "SDL_JOYSTICK_DIRECTINPUT";

    /// <summary>Gets or sets a value indicating whether the hint is enabled or not.</summary>
    /// <remarks>
    /// The variable can be set to the following values:
    /// <list type="bullet">
    /// <item><see langword="true"/> (Default): Enable DirectInput detection.</item>
    /// <item><see langword="false"/>: Disable DirectInput detection.</item>
    /// </list>
