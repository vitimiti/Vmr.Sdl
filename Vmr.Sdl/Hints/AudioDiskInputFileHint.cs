// -----------------------------------------------------------------------
// <copyright file="AudioDiskInputFileHint.cs" company="Vmr.Sdl">
...
/// <summary>Specify the input file when recording audio using the disk audio driver.</summary>
/// <remarks>You can set this hint through the environment variable "SDL_AUDIO_DISK_INPUT_FILE".</remarks>
public class AudioDiskInputFileHint : HintBase
{
    private const string Hint = "SDL_AUDIO_DISK_INPUT_FILE";
