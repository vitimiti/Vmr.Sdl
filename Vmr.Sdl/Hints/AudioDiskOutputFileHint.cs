// -----------------------------------------------------------------------
// <copyright file="AudioDiskOutputFileHint.cs" company="Vmr.Sdl">
...
/// <summary>Specify the output file when playing audio using the disk audio driver.</summary>
/// <remarks>You can set this hint through the environment variable "SDL_AUDIO_DISK_OUTPUT_FILE".</remarks>
public class AudioDiskOutputFileHint : HintBase
{
    private const string Hint = "SDL_AUDIO_DISK_OUTPUT_FILE";
