// -----------------------------------------------------------------------
// <copyright file="AutoUpdateJoysticksHint.cs" company="Vmr.Sdl">
...
/// <summary>A variable controlling whether SDL updates the joystick state when getting input events.</summary>
/// <remarks>You can set this hint through the environment variable "SDL_AUTO_UPDATE_JOYSTICKS" with the values "1" to enable or "0" to disable.</remarks>
public class AutoUpdateJoysticksHint : HintBase
{
    private const string Hint = "SDL_AUTO_UPDATE_JOYSTICKS";

    // TODO: Change SDL_UpdateJoysticks to our object docs
