// -----------------------------------------------------------------------
// <copyright file="AudioDriverHint.cs" company="Vmr.Sdl">
...
/// <para>You can set this hint through the environment variable "SDL_AUDIO_DRIVER".</para>
/// </remarks>
public class AudioDriverHint : HintBase
{
    private const string Hint = "SDL_AUDIO_DRIVER";
